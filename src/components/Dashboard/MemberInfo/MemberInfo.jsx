...
const MemberInfo = ({ member, handleCancel }) => {
    ...
    return (
      <div>
        <div className=' w-full px-10 md:px-6 bg-[#fff] md:h-[130vh]  '>
          <div className='bg-[#fff]'>
            <div className='rounded-full border-2 w-10 h-10 mt-8 flex items-center justify-center cursor-pointer' onClick={handleCancel} >
              <Cancel/>
            </div>
